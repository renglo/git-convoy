...
HELP_SECTIONS: list[HelpSection] = [
    ...
    },
    {
        ...
        "commands": [
            ...
            "git convoy adopt --production --bom ops/<system>-bom",
    ...
    {
        "name": "Adopt — Manual BOM primitives",
        "commands": [
            "git convoy adopt --require-verify --bom ops/<system>-bom",
            "git convoy adopt --no-verify --bom ops/<system>-bom",
            "git convoy adopt draft --from 1.4.0 --to 1.4.1 --bom ops/<system>-bom",
            "git convoy adopt pin 1.4.1 renglo-lib 1.2.5 --bom ops/<system>-bom",
            "git convoy adopt point 1.4.1 --bom ops/<system>-bom",
        ],
    },
    {
